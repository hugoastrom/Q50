...
class QubitAdaptVQE():
    ...
    def __init__(self, ansatz, hamiltonian, nqubits, optimizer):
       """
       Args:
    ...
    def commutator(self, a, b, appended_ops, paramstring):
    ...
    def optimize_params(self, paramstring):

        theta = paramstring
        res = minimize(energy, theta, method = self.optimizer, options={'xatol': 1e-8, 'disp': True})

        return res.x

    def minimize_energy(self, nshots, maxiter):
